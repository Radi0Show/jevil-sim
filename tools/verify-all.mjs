...
const SUITES = [
  ...
  ['verify-contact.mjs', 'collision model — 9,600 recorded pair-test verdicts, 3 sweeps'],
  ['verify-audio.mjs', 'every attack audible, no per-frame stacking, cues indexed'],
  ['verify-audio-coverage.mjs', 'every live-object GML sound cued or excused'],
